    ...
    <div className="relative bg-gray-50 pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8">
      ...
      <div className="relative max-w-7xl mx-auto">
        <div className="text-center">
          ...
          Here are my thoughts on a bunch of topics that are taking my interest at the moment!
          </p>
        </div>
        <div className="mt-12 max-w-lg mx-auto grid gap-5 lg:grid-cols-3 lg:max-w-none">
          {posts.map(({ frontmatter: { title, description, date, image, series, authorImage, authorName }, slug }) => (
              ...
              <div className="flex-1 bg-white p-6 flex flex-col justify-between">
                <div className="flex-1">
                  <p className="text-sm font-medium text-indigo-600">
                    <a href={`blog/${slug}.md`} className="hover:underline">
                      {series}
                    </a>
                  </p>
                  <a href={`blog/${slug}.md`} className="block mt-2">
